...
(function($) {
    $.widget('bionext.bioviztoolbar', {
        ...
        updateDisabledButtons: function() {
            ...
            var repr = this.bioviz.bioviz('getAvailableRepresentations', selection);

            for (var i = 0; i < repr.length; repr++) {
                $('#toolbar' + repr[i].commandName).button('option', 'disabled', buttonState);
            }
        },
        /**
