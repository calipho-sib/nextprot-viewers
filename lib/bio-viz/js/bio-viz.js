...
//            var positions = d.targetingIsoformsMap[Object.keys(d.targetingIsoformsMap)[0]];
            ...
            return {
                ...
                position: positions ? positions.firstPosition + "-" + positions.lastPosition : "NA",
                links: name
            }
        });
                ...
                "columnDefs": [
                    {
                        ...
                        "render": function (data, type, full, row) {
                            return '<a href="http://www.pdb.org/pdb/explore/explore.do?pdbId=' + data + '" class="btn btn-labeled btn-info btn-xs" type="button" target="_blank"><span class="btn-label">PDB</span>' + data + '</a>';
                        }
                    },
                    {
                        "targets": "pdbLinks",
