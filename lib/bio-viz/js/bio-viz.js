                ...
                "columnDefs": [
                    {
                        ...
                        "render": function (data, type, full, row) {
                            return '<a href="http://www.pdb.org/pdb/explore/explore.do?pdbId=' + data + '" class="btn btn-default btn-xs extLink" type="button" target="_blank">' + data + '</a>';
                        }
                    },
                    {
                        "targets": "pdbLinks",
                        "render": function (data, type, full, row) {
                            return '<a href="http://www.ebi.ac.uk/pdbsum/' + data + '" class="btn btn-default btn-xs extLink" type="button" target="_blank">PDBsum</a><a href="http://www.proteopedia.org/wiki/index.php/' + data + '" class="btn btn-default btn-xs extLink" type="button" target="_blank">Proteopedia</a>';
                        }
                    }
                ]
            });
